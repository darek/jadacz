...
/**
 * Holds all information about message. From/to who it is sent, when and what is the message.
...
//	    it should be ok :)
    ...
    public String toString() {
        return new String("Message( jid:"+this.getJID()+
        	" | time:"+
    ...
    public String toShortString() {
        return new String("Message("+this.getJID()+
        	"|"+new Date(time).toString() + " " + 
        	new Time(time).toString() +
        	"|" + this.getContent()+")");
    }
    ...
    /**
     * Checks if current Message object is equal to (has the same values) as the given in param.
     * @param message object to equal with
