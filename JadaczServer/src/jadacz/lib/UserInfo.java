...
/**
 * Class which holds user information. This is what is hold in database.
...
//	    it should be ok :)
    ...
    /**
     * Allows to write UserInfo object to stream as String.
     */
    public String toString() {
        return new String("UserInfo( nick:"+this.getNick()+
        	" | name:"+this.getName()+" | city:"+this.getCity()+
        	" | birthYear:"+this.getBirthYear()+" | gender:"+(this.isFemale()?"female":"male")+" )");
    }
    ...
    public String toShortString() {
        return new String("UserInfo("+this.getNick()+
        	"|"+this.getName()+"|"+this.getCity()+
        	"|"+this.getBirthYear()+"|"+(this.isFemale()?"female":"male")+")");
    }

    /**
     * Checks if current UserInfo object is equal to (has the same values) as the given in param.
     * @param userInfo object to equal with
